...
import { TITLES_ENGINE_BOTTOM } from '../const/titles';
...
interface IDetailEngine extends IModalDetail {
  entity: IEngineBottom;
}

export const DetailEngineBottom: React.FC<IDetailEngine> = ({ entity }) => {
      ...
      <View style={CNstyles.BtnContainerDetails}>
        <View style={{ margin: 10 }}>
          <Text style={styles.itemInfo}>
            {TITLES_ENGINE_BOTTOM.number}: <Text style={styles.itemInfoa1}>{entity?.name}</Text>
          </Text>
          <Text style={styles.itemInfo}>
            {TITLES_ENGINE_BOTTOM.formularNumber}: <Text style={styles.itemInfoa1}>{entity?.formularNumber}</Text>
          </Text>
          <Text style={styles.itemInfo}>
            {TITLES_ENGINE_BOTTOM.paintNumber}: <Text style={styles.itemInfoa1}>{entity?.drawingNumber}</Text>
          </Text>
          <Text style={styles.itemInfo}>
            {TITLES_ENGINE_BOTTOM.date}:{' '}
