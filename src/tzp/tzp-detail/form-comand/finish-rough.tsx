...
export const FinishRough = ({ route }: INavigate<ITzpDetail, null>): ReactElement => {
    ...
    <View style={CNstyles.FormContainer}>
      <View style={{ margin: 20 }}>
        ...
        <GoNext
          ...
          dtoTransitions={null}
          endpoint={endpointTransition.FINISH_ROUGH}
          entity={entity}
          isActive={true}
          title={ETransitionsUa.TRANSITION_FINISH_ROUGH + '?'}
        />
        <View style={CNstyles.defaultHeight} />
        <GoBack />
      </View>
