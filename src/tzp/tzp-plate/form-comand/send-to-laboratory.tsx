...
export const TZPDetailSampleSendToLaboratory = ({ route }: INavigate<ITzpDetailSample, null>): ReactElement => {
    ...
    <View style={CNstyles.FormContainer}>
      <View style={{ margin: 20 }}>
        ...
        <GoNext
          ...
          dtoTransitions={null}
          endpoint={endpointTransition.TRANSITION_SEND_TO_LABORATORY}
          entity={entity}
          isActive={true}
          title={ETransitionsUK.TRANSITION_SEND_TO_LABORATORY + '?'}
        />
        <View style={CNstyles.defaultHeight} />
        <GoBack />
      </View>
