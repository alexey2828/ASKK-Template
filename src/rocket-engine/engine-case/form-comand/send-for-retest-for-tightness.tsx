...
export const SendForRetestForTighrness = ({ route }: INavigate<IEngineCase, null>): ReactElement => {
    ...
    <View style={CNstyles.FormContainer}>
      <View style={{ margin: 20 }}>
        ...
        <GoNext
          ...
          dtoTransitions={null}
          endpoint={endpointTransition.SEND_FOR_RETEST_FOR_TIGHTNESS}
          entity={entity}
          isActive={true}
          title={ETransitionsUK.commandSendForRetestForTightness + '?'}
        />
        <View style={CNstyles.defaultHeight} />
        <GoBack />
      </View>
