...
type TPutIntoKm1Polymerization = {
...
export const PutIntoKm1Polymerization = ({
  route,
}: INavigate<IEngineCase, TPutIntoKm1Polymerization>): ReactElement => {
  ...
  const [putIntoAAPPolymezationDto, setPutIntoAAPPolymezationDto] = useState<TPutIntoKm1Polymerization | null>(null);
        ...
        {putIntoAAPPolymezationDto ? (
          <>
            <GoNext
              ...
              endpoint={endpointTransition.PUT_INTO_KM1_POLYMERIZATION}
              entity={entity}
              title={ETransitionsUK.commandPutIntoKM1Polymerization + '?'}
            />
          </>
        ) : (
          <LockButton />
