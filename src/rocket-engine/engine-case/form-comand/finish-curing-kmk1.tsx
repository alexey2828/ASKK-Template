...
export const FinishCuringKMK1 = ({ route }: INavigate<IEngineCase, null>): ReactElement => {
    ...
    <View style={CNstyles.FormContainer}>
      <View style={{ margin: 20 }}>
        ...
        <GoNext
          ...
          dtoTransitions={null}
          endpoint={endpointTransition.FINISH_CURING_KMK1}
          entity={entity}
          isActive={true}
          title={ETransitionsUK.commandFinishCuringKMK1 + '?'}
        />
        <View style={CNstyles.defaultHeight} />
        <GoBack />
      </View>
