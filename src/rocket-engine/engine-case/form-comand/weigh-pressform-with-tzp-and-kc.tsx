...
type TWeightPressformWithTzpAndKcDto = {
...
export const WeightPressformWithTzpAndKc = ({
  route,
}: INavigate<IEngineCase, TWeightPressformWithTzpAndKcDto>): ReactElement => {
  ...
  const [weightPressformWithTzpAndKcDto, setWeightPressformWithTzpAndKcDto] =
    useState<TWeightPressformWithTzpAndKcDto | null>(null);
  ...
  useEffect(() => {
    if (premises && validWeight.valid && apparatchikUser && masterUser) {
      setWeightPressformWithTzpAndKcDto({
      ...
      setWeightPressformWithTzpAndKcDto(null);
    }
  ...
  return (
    <View style={CNstyles.FormContainer}>
      ...
      <View style={{ margin: 20 }}>
        ...
        <View style={CNstyles.defaultHeight} />
        {weightPressformWithTzpAndKcDto ? (
          <>
            <GoNext
              routeName={ENavigationName.CHANGE_STATE_ENGINE_CASES}
              dtoTransitions={weightPressformWithTzpAndKcDto}
              endpoint={endpointTransition.WEIGH_PRESSFORM_WITH_TZP_AND_KC}
              entity={entity}
              title={ETransitionsUK.commandWeighPressformWithTzpAndKc + '?'}
