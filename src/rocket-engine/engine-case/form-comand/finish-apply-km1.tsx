...
export const FinishApplyKM1 = ({ route }: INavigate<IEngineCase, null>): ReactElement => {
    ...
    <View style={CNstyles.FormContainer}>
      <View style={{ margin: 20 }}>
        ...
        <GoNext
          ...
          dtoTransitions={null}
          endpoint={endpointTransition.FINISH_APPLYING_KM1}
          entity={entity}
          isActive={true}
          title={ETransitionsUK.commandFinishApplyingKM1 + '?'}
        />
        <View style={CNstyles.defaultHeight} />
        <GoBack />
      </View>
